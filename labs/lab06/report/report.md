...
С помощью утилиты mkdir создаю директорию, в которой буду создавать файлы с программами для лабораторной работы №6 (рис. [-@fig:001]). Перехожу в созданный каталог с помощью утилиты cd.С помощью утилиты touch создаю файл lab6-1.asm 

![Создание директории и создание файла](image/1.png){ #fig:001 width=70% }
...
![Создание копии файла](image/2.png){ #fig:003 width=70% }
...
Создаю новый файл lab6-3.asm с помощью утилиты touch (рис. [-@fig:008]).
...
Создаю и запускаю исполняемый файл lab6-3 (рис. [-@fig:010]). Теперь вывод число 106, потому что программа позволяет вывести именно число, а не символ, хотя все еще происходит именно сложение кодов символов "6" и "4".

![Запуск исполняемого файла](image/10.png){ #fig:010 width=70% }

Заменяю в тексте программы в файле lab6-3.asm символы "6" и "4" на числа 6 и 4 (рис. [-@fig:011]).
...
Создаю файл lab6-4.asm с помощью утилиты touch (рис. [-@fig:015]).
...
Создаю и запускаю исполняемый файл (рис. [-@fig:022]). Ввожу номер своего студ. билета с клавиатуры, программа вывела, что мой вариант - 1.
...
Создаю файл lab6-5.asm с помощью Midnight Commander (рис. [-@fig:023]).

![Создание файла](image/23.png){ #fig:023 width=70% }

Открываю созданный файл для редактирования, ввожу в него текст программы для вычисления значения выражения (10 + x*2) / 3 (рис. [-@fig:024]). Это выражение было под вариантом 1.

![Написание программы](image/30.png){ #fig:024 width=70% }

Создаю и запускаю исполняемый файл (рис. [-@fig:025]). При вводе значения 1, вывод - 4.

![Запуск исполняемого файла](image/31.png){ #fig:025 width=70% }
...
![Запуск исполняемого файла](image/32.png){ #fig:026 width=70% }
